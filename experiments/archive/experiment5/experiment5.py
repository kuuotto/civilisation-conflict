...
exploration_coefs = (0.3, 0.5)
attack_rewards = (0, -0.1)
action_dists_0 = ("random", "passive")
...
# there are a total of 16 * 128 * (1 + 2) + 16 * 128 * (2 + 2)
# 6144 + 8192 = 14336
...
# experiment.
# run 0...383: experiment 5a, each one runs 16 individual m.e.s
# run 384..895: experiment 5b, each one runs 16 individual m.e.s
